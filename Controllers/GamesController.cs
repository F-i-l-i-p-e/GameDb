...
namespace GameDb.Controllers
{
    public class GamesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("GameId,Title,Genre,Developer,Publisher,Price")] Game game)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("GameId,Title,Genre,Developer,Publisher,Price")] Game game)
        {
            if (id != game.GameId)
            {
                return NotFound();
